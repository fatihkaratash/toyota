...
public class DefaultRateValidator implements RateValidator {
    ...
    @PostConstruct
    public void init() {
        // Add any default validation rules here if needed
        // This would typically come from a configuration or be injected
        logger.info("DefaultRateValidator başlatıldı");
    }
